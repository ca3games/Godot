...
onready var interval = preload("res://Scenes/Giano Remapper/Scenes/Interval.tscn")
onready var rowintervalcontainer = preload("res:///Scenes/Giano Remapper/Scenes/IntervalContainer.tscn")
